...
unsafe extern "C" {
    pub fn au_av_generator_create(component_type: u32, component_subtype: u32, component_manufacturer: u32, component_flags: u32, component_flags_mask: u32, out_unit: *mut *mut c_void, out_error_msg: *mut *mut c_char) -> i32;
