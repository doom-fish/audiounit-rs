...
unsafe extern "C" {
    pub fn au_voice_io_create(options: u32, out_unit: *mut *mut c_void, out_error_msg: *mut *mut c_char) -> i32;
    ...
    pub fn au_voice_io_set_other_audio_ducking(ptr: *mut c_void, enable_advanced: bool, ducking_level: u32) -> i32;
}
